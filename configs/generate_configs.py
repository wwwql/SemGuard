...
parser.add_argument("-t","--test_path", default="/data/SemDiff/test", type=str, help='Path to test samples')
...
parser.add_argument("-e","--end", default=120, type=int, help='end index of test samples')
